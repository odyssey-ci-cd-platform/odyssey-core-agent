...
- Open core. Free OSS base (engine + CLI + basic orchestration), paid hosted tier for: intelligence layer (flakiness, ownership, analytics), SSO/RBAC, managed infrastructure.
